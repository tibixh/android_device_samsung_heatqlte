...
LOCAL_SHARED_LIBRARIES        := $(common_libs) libmemalloc.heat
LOCAL_SHARED_LIBRARIES        += libqdutils.heat libGLESv1_CM
...
LOCAL_MODULE                  := libmemalloc.heat
LOCAL_MODULE_TAGS             := optional
LOCAL_C_INCLUDES              := $(common_includes) $(kernel_includes)
LOCAL_SHARED_LIBRARIES        := $(common_libs) libqdutils.heat libdl
